...
def predict_custom_range(start_date, end_date):
    ...
    print(f"Custom predictions from {start_date} to {end_date} have been saved.")
...
if __name__ == "__main__":
    ...
    print(f"\nPredicting for custom time range ({start_date} to {end_date}):")
    predict_custom_range(start_date, end_date)