...
# 加载模型和归一化参数
checkpoint = torch.load('2000epoch_best_model.pt', map_location=device)
...
# 检查预测值和真实值
print("First 10 predicted values (after scaling):", predictions_original_scale[:10])
print("First 10 true values:", true_values[:10])
